...
def mock_user(seq,dt,row_cnt):
    faker = Faker(locale='zh_CN')
    faker.seed(int(random.random() * 10000000000))
    print('step into profile.........')
    with open('/home/dataservice/workspace/mock/result/seq/profile/new/1127/test_profile_new_%s.csv' % dt, 'w') as f:
	    ...
	    birthdate = ''
            ssn = faker.ssn()
            job = faker.job()
            f.write('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n' % (seq,user_id,user_name,address,sex,email,phone,birthdate,ssn,job,dt))
            seq += 1
            if num % 10000 == 0:
                f.flush()
...
if __name__ == "__main__":
    ...
    for index, i in enumerate(range(0, total, page_size)):
        ...
        p.apply_async(mock_user,(i + 1,t_str, page_size))
